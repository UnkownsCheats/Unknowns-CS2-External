...
namespace zui {
	...
	struct style
	{
		...
		zdraw::rgba window_bg{ 10, 10, 10, 255 };
		...
		zdraw::rgba combo_item_hovered{ 30, 30, 30, 255 };
		zdraw::rgba combo_item_selected{ 180, 160, 255, 35 };

		zdraw::rgba color_picker_bg{ 20, 20, 20, 255 };
		zdraw::rgba color_picker_border{ 60, 60, 60, 255 };

		zdraw::rgba text_input_bg{ 20, 20, 20, 255 };
		zdraw::rgba text_input_border{ 60, 60, 60, 255 };

		zdraw::rgba text{ 220, 220, 220, 255 };
		zdraw::rgba accent{ 180, 160, 255, 255 };
	};
