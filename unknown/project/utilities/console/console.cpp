...
namespace detail {
	...
	static constexpr auto k_dim{ "\033[38;2;40;40;50m" };
	static constexpr auto k_text{ "\033[38;2;180;160;255m" };
	...
	static constexpr rgb k_accent_light{ 180, 160, 255 };
	static constexpr rgb k_accent_dark{ 100, 80, 180 };
...
void console::emit( level lvl, const std::string& message ) const
{
	...
	const auto label = detail::gradient_text( "Unknownツ", grad_from, grad_to );
